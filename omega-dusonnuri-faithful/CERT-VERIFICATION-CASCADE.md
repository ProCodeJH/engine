...
**Issued**: 2026-04-28T09:13:38.010Z
...
| 3. Visual diff | ✅ | composite 51.94% (POOR) — pxl=53.52 pHash=46.88 ssim=77.39 hist=70.9 |
| 4. Motion | ✅ | css=0 gsap=true js=1 |
| 5. A11y | ❌ | missing-alt=1 skip=true |
| 6. SEO | ✅ | title=true og=true jsonLd=true sitemap=false |
